...
export default function About(props) {
    ...
    return (
        <div className="container p-2" style={myStyle}>
            ...
            <div class="accordion" id="accordionExample" >
                <div class="accordion" id="accordionPanelsStayOpenExample">
                    <div class="accordion-item">
                        ...
                        <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" style={myStyle}>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" style={myStyle} data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
                                Accordion Item #2
                            </button>
                        </h2>
            ...
            {/* <button className="btn btn-primary my-2" onClick={changeMode}>{btnText}</button> */}
        </div>
